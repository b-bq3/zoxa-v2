#!/usr/bin/env python3
# Gemini Client — Zoxa Icon Generator
# Usage: python3 gemini-zoxa.py
...
print(f'✅ Boot OK — Token: {tok[:20]}...')

# Prompt for Zoxa icon
prompt = """Create a professional PWA app icon for "Zoxa" — a Minecraft addons website.
The icon should be 512x512, dark theme (#0f0f19 background), rounded square with red border glow.
In the center: a large pixel-art style letter "Z" in red gradient (#ff4444 to #b91c1c).
Behind the Z: a Minecraft pickaxe tool crossing diagonally.
Decorate with small gold stars in corners.
At the bottom: text "ZOXA" in red pixel font.
Game app icon style, high quality, sharp."""
